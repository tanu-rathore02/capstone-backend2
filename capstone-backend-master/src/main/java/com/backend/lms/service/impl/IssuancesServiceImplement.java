...
//                .map(IssuancesMapper::mapToIssuanceOutDto)
...
//            issuancePage = issuancesRepository.findByBook_TitleContainingIgnoreCase(search, pageable);
//        } else {
//            issuancePage = issuancesRepository.findAll(pageable);
//        }
//
//        return issuancePage.map(IssuancesMapper::mapToIssuanceOutDto);
//    }
//
//    @Override
...
//        );
//        return IssuancesMapper.mapToIssuanceOutDto(issuance);
//    }
//
//    @Override
...
//        return IssuancesMapper.mapToIssuanceOutDto(savedIssuance);
//    }
//
//    @Override
...
//        List<Issuances> issuancesList = issuancesRepository.findAllByUserId(userId);
...
//
//    @Override
//    public List<IssuanceOutDto> getIssuanceByMobile(String mobileNumber) {
//        List<Issuances> issuancesList = issuancesRepository.findAllByUserMobile(mobileNumber);
//        return issuancesList.stream()
//                .map(IssuancesMapper::mapToIssuanceOutDto)
//                .collect(Collectors.toList());
//    }
